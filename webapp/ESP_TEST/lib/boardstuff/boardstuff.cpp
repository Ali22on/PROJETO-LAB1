...
extern void set_led(uint32_t hex_color, byte _brightness)
{
    // Extract the red, green, and blue components from the hex color
    uint8_t red = (hex_color >> 16) & _brightness;
    uint8_t green = (hex_color >> 8) & _brightness;
    uint8_t blue = hex_color & _brightness;
